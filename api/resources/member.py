...
class Member(Resource):
    ...
    def post(self):
        ...
        likes_text = create_list_of_likes(
            self.df,
            args["likes"],
            list_prefix="|",
            list_postfix="",
        ...
        r = post(
            "https://us3.api.mailchimp.com/3.0/lists/{}/members/{}/events".format(
